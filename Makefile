...
#CC = gcc
#CC = /opt/fslc-framebuffer/2.5/sysroots/x86_64-fslcsdk-linux/usr/bin/arm-fslc-linux-gnueabi/arm-fslc-linux-gnueabi-gcc
CC = /opt/fslc-framebuffer/2.5/sysroots/x86_64-fslcsdk-linux/usr/bin/arm-fslc-linux-gnueabi/arm-fslc-linux-gnueabi-gcc -g -march=armv7-a -mthumb -mfpu=neon -mfloat-abi=hard --sysroot=/opt/fslc-framebuffer/2.5/sysroots/armv7at2hf-neon-fslc-linux-gnueabi -pthread
export CC
...
#aggiunta D&V
TLS_INCLUDE_DIR += -I $(MBEDTLS_DIR)/crypto/include
...
$(info INCLUDE_ALL_DIRS="$(INCLUDE_ALL_DIRS)")
