...
#define AWS_IOT_MQTT_CLIENT_ID         "logicafm_99998" //"c-sdk-client-id" ///< MQTT client ID should be unique for every device
#define AWS_IOT_MY_THING_NAME 	       "logicafm_99998"//"AWS-IoT-C-SDK" ///< Thing Name of the Shadow this device is associated with
#define AWS_IOT_ROOT_CA_FILENAME       "AmazonRootCA1.pem" ///< Root CA file name
#define AWS_IOT_CERTIFICATE_FILENAME   "635638e7fc-certificate.pem.crt"//.cert.pem" ///< device signed certificate file name
#define AWS_IOT_PRIVATE_KEY_FILENAME   "635638e7fc-private.pem.key"//.private.key" ///< Device private key filename
// =================================================

// MQTT PubSub
#define AWS_IOT_MQTT_TX_BUF_LEN 1024*5//512 ///< Any time a message is sent out through the MQTT layer. The message is copied into this buffer anytime a publish is done. This will also be used in the case of Thing Shadow
#define AWS_IOT_MQTT_RX_BUF_LEN 1024*5//512 ///< Any message that comes into the device should be less than this buffer size. If a received message is bigger than this buffer size the message will be dropped.
